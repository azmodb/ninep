...
var generatedLinuxPackets = []packet{
	...
	packet{&Tgetattr{Fid: math.MaxUint32, RequestMask: math.MaxUint64}, &Tgetattr{}},
	...
	packet{&Tfsync{}, &Tfsync{}},
	packet{&Tfsync{Fid: math.MaxUint32}, &Tfsync{}},
	packet{&Rfsync{}, &Rfsync{}},
	packet{&Tlock{}, &Tlock{}},
	packet{&Tlock{Fid: math.MaxUint32, Type: math.MaxUint8, Flags: math.MaxUint32, Start: math.MaxUint64, Length: math.MaxUint64, ProcID: math.MaxUint32, ClientID: string16.String()}, &Tlock{}},
	packet{&Rlock{}, &Rlock{}},
	packet{&Rlock{Status: math.MaxUint8}, &Rlock{}},
	packet{&Tgetlock{}, &Tgetlock{}},
	packet{&Tgetlock{Fid: math.MaxUint32, Type: math.MaxUint8, Start: math.MaxUint64, Length: math.MaxUint64, ProcID: math.MaxUint32, ClientID: string16.String()}, &Tgetlock{}},
	packet{&Rgetlock{}, &Rgetlock{}},
	packet{&Rgetlock{Type: math.MaxUint8, Start: math.MaxUint64, Length: math.MaxUint64, ProcID: math.MaxUint32, ClientID: string16.String()}, &Rgetlock{}},
	packet{&Tlink{}, &Tlink{}},
	packet{&Tlink{DirectoryFid: math.MaxUint32, Target: math.MaxUint32, Name: string16.String()}, &Tlink{}},
	packet{&Rlink{}, &Rlink{}},
	packet{&Tmkdir{}, &Tmkdir{}},
	packet{&Tmkdir{DirectoryFid: math.MaxUint32, Name: string16.String(), Permission: math.MaxUint32, Gid: math.MaxUint32}, &Tmkdir{}},
	packet{&Trenameat{}, &Trenameat{}},
	packet{&Trenameat{OldDirectoryFid: math.MaxUint32, OldName: string16.String(), NewDirectoryFid: math.MaxUint32, NewName: string16.String()}, &Trenameat{}},
	packet{&Rrenameat{}, &Rrenameat{}},
	packet{&Tunlinkat{}, &Tunlinkat{}},
	packet{&Tunlinkat{DirectoryFid: math.MaxUint32, Name: string16.String(), Flags: math.MaxUint32}, &Tunlinkat{}},
	packet{&Runlinkat{}, &Runlinkat{}},
}
